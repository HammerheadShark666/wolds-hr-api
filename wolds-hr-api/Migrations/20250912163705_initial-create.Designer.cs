...
namespace wolds_hr_api.Migrations
{
    ...
    [Migration("20250912163705_initial-create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wolds_hr_api.Domain.ImportEmployeeFailErrorHistory", b =>
                {
                    ...
                    b.ToTable("WOLDS_HR_ImportEmployeeFailErrorHistory", (string)null);
                });
            ...
            modelBuilder.Entity("wolds_hr_api.Domain.ImportEmployeeFailErrorHistory", b =>
                {
                    b.HasOne("wolds_hr_api.Domain.ImportEmployeeFailHistory", "ImportEmployeeFailHistory")
                        .WithMany("Errors")
                        .HasForeignKey("ImportEmployeeFailHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImportEmployeeFailHistory");
                });
